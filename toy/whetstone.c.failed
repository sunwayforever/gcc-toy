...
IILOOP:
...
#endif
    if (JJ == II) {
        assert(fabs(X1 - 1.0) < 0.01);
        assert(fabs(X2 + 1.0) < 0.01);
        assert(fabs(X3 + 1.0) < 0.01);
        assert(fabs(X4 + 1.0) < 0.01);
    }
    /*
    C
...
#endif
    IF(JJ == II) {
        assert(fabs(E1[1] + 6.83e-2) < 0.01);
        assert(fabs(E1[2] + 4.626e-1) < 0.01);
        assert(fabs(E1[3] + 7.2972e-01) < 0.01);
        assert(fabs(E1[4] + 1.1240) < 0.01);
    }
    /*
    C
...
#endif
    IF(JJ == II) {
        assert(fabs(E1[1] + 5.5336e-02) < 0.01);
        assert(fabs(E1[2] + 4.4744e-01) < 0.01);
        assert(fabs(E1[3] + 7.1097e-01) < 0.01);
        assert(fabs(E1[4] + 1.1031e+00) < 0.01);
    }
    /*
    C
...
#endif
    IF(JJ == II) {
        assert(fabs(E1[1] - 6.0) < 0.01);
        assert(fabs(E1[2] - 6.0) < 0.01);
        assert(fabs(E1[3] + 7.1097e-01) < 0.01);
        assert(fabs(E1[4] + 1.1031) < 0.01);
    }
    /*
    C
    ...
    */
    ...
    for (I = 1; I <= N7; I++) {
        X = T *
            DATAN(T2 * DSIN(X) * DCOS(X) / (DCOS(X + Y) + DCOS(X - Y) - 1.0));
        Y = T *
            DATAN(T2 * DSIN(Y) * DCOS(Y) / (DCOS(X + Y) + DCOS(X - Y) - 1.0));
    }
#ifdef PRINTOUT
    IF(JJ == II) POUT(N7, J, K, X, X, Y, Y);
#endif
    IF(JJ == II) {
        assert(fabs(X - 4.9041e-01) < 0.01);
        assert(fabs(Y - 4.9039e-01) < 0.01);
    }
    /*
    C
...
#endif
    IF(JJ == II) {
        assert(fabs(X - 1.0) < 0.01);
        assert(fabs(Y - 1.0) < 0.01);
        assert(fabs(Z - 9.9994e-01) < 0.01);
    }
    /*
    C
...
#endif
    IF(JJ == II) {
        assert(fabs(E1[1] - 3.0) < 0.01);
        assert(fabs(E1[2] - 2.0) < 0.01);
        assert(fabs(E1[3] - 3.0) < 0.01);
        assert(fabs(E1[4] + 1.1031e+00) < 0.01);
    }
    /*
    C
    ...
    */
    X = 0.75;
    for (I = 1; I <= N11; I++) X = DSQRT(DEXP(DLOG(X) / T1));
#ifdef PRINTOUT
    IF(JJ == II) POUT(N11, J, K, X, X, X, X);
#endif
    IF(JJ == II) { assert(fabs(X - 8.3467e-01) < 0.01); }
    /*
    C
...
void POUT(long N, long J, long K, double X1, double X2, double X3, double X4) {
    printf(
        "%7ld %7ld %7ld %12.4e %12.4e %12.4e %12.4e\n", N, J, K, X1, X2, X3,
        X4);
}
#endif
